...
import { useCountries, useFixturesByDate } from "@/services/football/queries";
import {
  filterDataByStatus,
  formatDatePattern,
  getItemsByLeague,
...
const Football = () => {
  ...
  const groupFixturesByStatus = useMemo(
    () =>
      fixturesQuery.data ? filterDataByStatus(fixturesQuery.data) : undefined,
    [fixturesQuery.data]
  );
      ...
      <div className="px-6 border border-b shadow-sm sticky top-0 bg-background z-10">
        <div className="py-6 flex justify-between items-center">
          <h2 className="text-2xl flex items-center gap-3 text-secondary-foreground font-medium">
            <FootballLogo width={30} height={30} />
            Games
          </h2>
